...
description: Codex CLI installation and setup guide — configure this terminal-based AI coding agent with TokenFactory on Windows, macOS, and Linux. Supports sandboxing and patch editing.
---
...
<Callout type="info" title="One-click Modification of Codex CLI Configuration File">
  ```powershell
  iex (irm 'https://raw.githubusercontent.com/fyinfor/token-factory-docs/refs/heads/main/helper/codex-cli-setup.ps1')
  ```
</Callout>
...
<Callout type="info" title="One-click Modification of Codex CLI Configuration File">
  ```bash
  curl -fsSL https://raw.githubusercontent.com/fyinfor/token-factory-docs/refs/heads/main/helper/codex-cli-setup.sh | bash
  ```
</Callout>
