...
description: Learn about TokenFactory, the next-generation AI Gateway and Asset Management System
---
...
<div className="my-8 text-center">
  <img
    ...
    height="120"
  />
  <h1 className="mt-4 mb-2 text-4xl font-bold">TokenFactory</h1>
  <img
...
TokenFactory is a next-generation AI foundation platform, providing unified infrastructure for your AI applications. It hosts all AI applications, manages your digital assets, and connects to a future unified interface platform.

<Callout type="info">
  TokenFactory seamlessly integrates with mainstream global AI service providers, including OpenAI, Anthropic, Google
...
TokenFactory adopts the **GNU AGPLv3** open-source license, which can be used for free as long as the terms of the open-source license are followed.

<Callout type="warn">
  Before using TokenFactory, please read the complete license terms in the [Project
  LICENSE](https://github.com/fyinfor/token-factory/blob/main/LICENSE).
</Callout>

### Open Source License (AGPLv3)

Under AGPLv3, you are free to use, modify, and distribute TokenFactory.
...
All contributions to TokenFactory are licensed under AGPLv3.
...
- In case of dispute, please refer to the official [LICENSE](https://github.com/fyinfor/token-factory/blob/main/LICENSE) document

## Disclaimer

<Callout type="error">Before using TokenFactory, please read and understand these important statements.</Callout>
...
<Callout type="warn">
  TokenFactory is provided "as is" without any warranties of any kind. Developers and maintainers are not liable for any damages or legal issues arising from the use of this software.
</Callout>