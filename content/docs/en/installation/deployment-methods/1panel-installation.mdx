...
This document provides a graphical tutorial for deploying TokenFactory using the 1Panel panel.
...
## Step 2: Install TokenFactory

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the TokenFactory application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure TokenFactory application parameters on the installation page:
</Callout>

- **Name**: The name of the TokenFactory application to be created
- **Version**: Select the version of TokenFactory
- **Port**: The service port for the TokenFactory application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the TokenFactory application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the TokenFactory application
...
## Step 4: Access TokenFactory

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the TokenFactory WebUI page
...
2. Find the TokenFactory application, click the **Upgrade** button
...
- [GitHub Repository](https://github.com/fyinfor/token-factory)