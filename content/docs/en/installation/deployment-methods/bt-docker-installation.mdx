...
This document provides a graphical tutorial for deploying TokenFactory using the Baota Panel Docker feature.
...
4. Configure the following basic options:
   - **Container Name**: Customizable, defaults to `token-factory`
...
1. Create a website directory in Baota Panel, such as `/www/wwwroot/token-factory`
...
3. Enter Image Name: `calciumion/token-factory:latest`
...
6. Fill in the following information:
   - **Container Name**: `token-factory` (customizable)
   - **Image**: Select the `calciumion/token-factory:latest` image you just pulled
