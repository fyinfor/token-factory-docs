...
本文档提供了Token Factory系统的更新方法和最佳实践，以确保您的系统平稳升级到最新版本。
...
1. **备份数据**：备份数据库和重要配置文件
2. **查看更新日志**：在[GitHub Releases](https://github.com/fyinfor/token-factory/releases)查看最新版本的更新内容
...
如果您使用单个Docker容器部署了Token Factory，可以按照以下步骤更新：
...
2. 找到Token Factory容器，点击 **更多** -> **重新创建**
3. 勾选 **拉取最新镜像** 选项，确保其他配置保持不变
4. 点击 **提交** ，系统将自动拉取最新镜像并重新创建容器

## 从源码编译的更新方法

如果您是从源码编译部署的Token Factory，更新步骤如下：
